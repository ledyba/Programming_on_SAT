...
は上と見比べると、節が2つのCNFになっています。ここまでわかれば、
...
　が読解できます。それぞれの行は節を表していて、1や-1はpや!p、2はq、3はrを表しています。同じ行に数字を並べるとそれぞれorの意味になり、行と行はそれぞれandで繋いだものになっています。
　
　1や-1はそれぞれpと!pに対応しています。そして、節の区切りには0（＋改行）を使います。
